...
ZIP="${1:-/home/jairo/Documentos/Proyectos/jellyfin/jebstudios_jellyfin_volumen_maximun/dist/jebstudios_jellyfin_volumen_maximun_1.0.7.0.zip}"
PLUGINS="/var/lib/jellyfin/plugins"
TARGET="$PLUGINS/Volumen Maximum_1.0.7.0"
...
journalctl -u jellyfin --since '45 sec ago' --no-pager | grep -i 'VolumenMaximum\|Parches ffmpeg' || true
